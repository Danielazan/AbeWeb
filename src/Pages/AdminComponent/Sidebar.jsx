  ...
  return (
    <React.Fragment>
      ...
      <Offcanvas show={show} onHide={handleClose} responsive="lg">
        ...
        <Offcanvas.Body   style={{backgroundColor:"#fda07e"}} >
        
          <ListGroup  className="SideList mt-4" variant='flush'> 
              <ListGroup.Item style={{backgroundColor:"#210440",color:"#fda07e"}} className="border-white my-2 py-3 p-0 ms-lg-3 list" action ><MdRoofing className='me-2' size={"1.5em"}/>Roofing Collection</ListGroup.Item>
